...
final class SeanceRevisionController extends AbstractController
{
    ...
    ): Response
    {
        ...
        return $this->render('front/seance/index.html.twig', [
            'user' => $this->getUser(),
            'isStudent' => $isStudent,
            'isTutor' => $isTutor,
    ...
    public function plannerPage(Request $request, RevisionPlannerRepository $revisionPlannerRepository): Response
    {
        ...
        return $this->render('front/seance/planner_form.html.twig', [
            'user' => $this->getUser(),
    ...
    public function plannerResult(
        ...
        return $this->render('front/seance/planner_result.html.twig', [
            'user' => $this->getUser(),
            'planner' => $planner,
